...
CDC chunker using a gear-hash rolling hash over a 256-entry lookup table (`GEAR_TABLE`) generated at compile time by a LCG. Default parameters: min=8 KiB, max=64 KiB, target=16 KiB. The boundary mask is `(1 << floor(log2(target))) - 1`.
